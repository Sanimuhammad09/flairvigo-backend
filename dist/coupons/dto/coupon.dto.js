...
exports.ValidateCouponDto = exports.CreateCouponDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['percentage', 'fixed', 'free_shipping'] }),
    (0, class_validator_1.IsEnum)(['percentage', 'fixed', 'free_shipping']),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], ValidateCouponDto.prototype, "orderValue", void 0);
