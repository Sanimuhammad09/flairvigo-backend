...
let AdminInventoryController = class AdminInventoryController {
    ...
    async updateInventory(variantId, body) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get low stock inventory' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AdminInventoryController.prototype, "getLowStock", null);
__decorate([
    (0, common_1.Put)(':variantId'),
    (0, swagger_1.ApiOperation)({ summary: 'Update variant stock level' }),
    __param(0, (0, common_1.Param)('variantId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], AdminInventoryController.prototype, "updateInventory", null);
